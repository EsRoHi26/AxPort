...
INSERT INTO Recursos_Adicionales (nombre, descripcion, URL, imagen, descripcionImagen)
Values('CONAPDIS', 'El Conapdis es el rector en discapacidad, responsable de promover y fiscalizar el cumplimiento de los derechos humanos de la población con discapacidad, para fomentar su desarrollo inclusivo en todos los ámbitos de la sociedad.', 'https://conapdis.go.cr', '../assets/CONAPDIS.png', 'Logo del CONAPDIS'),
('Wheelmap.org', 'Wheelmap es una plataforma en línea que permite a los usuarios encontrar y compartir información sobre la accesibilidad de lugares en todo el mundo.', 'https://wheelmap.org', '../assets/WheelMap.png', 'Logo de Wheelmap.org'),
('Blog de Apps para Personas con Discapacidad', 'Blog que ofrece información sobre aplicaciones móviles y tecnología accesible para personas con discapacidad.', 'https://gaptain.com/blog/18-herramientas-digitales-para-personas-con-discapacidad/', '../assets/18.png', 'Imagen que muestra 4 cuadrados, 
3 de ellos con un cortorno gris, y el otro con un contorno azul, el que tiene contorno azul está en la esquina superior derecha y está en una posición diferente a los demás cuadrados.');
...
-- info de normas
INSERT INTO Informacion (tipo,titulo,descripcion) VALUES (5,'Ley de Igualdad de Oportunidades para las Personas con Discapacidad, Ley N° 7600',
...
para las Personas con Discapacidad, Ley N° 7600 y su reglamento.La Ley N° 7600 de Costa Rica, tiene como objetivo garantizar la igualdad de oportunidades
...
INSERT INTO Informacion (tipo,titulo,descripcion, nombreRecurso, linkRecurso) VALUES (5,'Reglamento de la Ley de Igualdad de Oportunidades para Personas con Discapacidad',
'La Ley N° 7600 de Costa Rica incluye disposiciones que garantizan la igualdad de oportunidades y la no discriminación para las
personas con discapacidad en áreas como educación, empleo, salud, transporte y accesibilidad en general.
Visite el siguiente link si desea saber más de la ', 'ley N° 7600.', 'https://www.asamblea.go.cr/sd/SiteAssets/Lists/Consultas%20Biblioteca/EditForm/Ley%207600.pdf');
INSERT INTO Informacion (tipo,titulo,descripcion, nombreRecurso, linkRecurso) VALUES (5,'Ley de Igualdad de Oportunidades para las Personas con Discapacidad',
...
Visite el siguiente link si desea saber más del ', 'reglamento de la ley N° 7600.', 'http://www.pgrweb.go.cr/scij/Busqueda/Normativa/Normas/nrm_texto_completo.aspx?param1=NRTC&nValor1=1&nValor2=53160&nValor3=91140&strTipM=TC');


-- Insert into Noticias
INSERT INTO Noticias (fecha,titulo,linkImagen, descripcionImagen,linkNoticia) VALUES ('27 de Noviembre 2023',
...
INSERT INTO Noticias (fecha,titulo,linkImagen, descripcionImagen,linkNoticia) VALUES ('02 de Noviembre 2022',
...
INSERT INTO Noticias (fecha,titulo,linkImagen, descripcionImagen,linkNoticia) VALUES ('20 de Julio 2022',
